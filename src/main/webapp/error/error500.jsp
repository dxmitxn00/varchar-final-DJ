...
<body>
	<p style="font-size: 30px; margin-top: 50px;"> 500에러!</p>
	<p style="font-size: 20px;">에러페이지에 오신 걸 환영합니다! 히든 게임을 진행해보세요:)</p>
	<p style="font-size: 17px;">코인을 모두 수집하면 다음 레벨로 넘어갑니다!</p>
