		...
		<div class="container">
			<div class="row no-gutters slider-text align-items-center justify-content-center">
				<div class="col-md-9 ftco-animate text-center">
					<p class="breadcrumbs">
						<span class="mr-2"><a href="main.do">Home</a></span> <span>Wishlist</span>
					</p>
					<h1 class="mb-0 bread">상세 주문내역</h1>
				</div>
			</div>
		</div>
	</div>
	...
	<section class="ftco-section ftco-cart">
		<div class="container">
			<c:forEach var="buyDetailData" items="${ buyDetailDatas }">
				<c:set var="buyNum" value="${ buyDetailData.buyNum }" />
			</c:forEach>
			<h2 style="font-size: 22px;" class="mb-0">주문번호 : ${ buyNum }</h2>
			<div class="row">
							...
							<tbody>
								<c:forEach var="buyDetailData" items="${ buyDetailDatas }">
									<form action="insertReviewPage.do?buySerial=${ buyDetailData.buySerial }" method="post">
										...
										<tr class="text-center">
											<td class="image-prod"><div class="img" style="background-image: url(${ buyDetailData.imageUrl });"></div></td>
											...
											<td class="quantity">
												<div class="input-group">
													<input type="text" name="quantity" class="quantity form-control input-number" value="${ buyDetailData.buyCnt }">
												</div>
											</td>

											<td><c:if test="${ buyDetailData.reviewDone == true }">
