				...
				<div class="col-md-12 ftco-animate">
					<div class="cart-list">
						<table class="table">
							...
							<tbody id="cartTbody">
								<c:if test="${ empty favorDatas }">
									<tr>
										<td colspan="4">찜한 상품이 없습니다.</td>
									</tr>
								</c:if>
								<c:if test="${ not empty favorDatas }">
									<form method="post" onSubmit="return false;">
										...
										<c:forEach var="favorData" items="${ favorDatas }">
											<tr id="favorForEach${ favorData.teaNum }" class="text-center">
												...
												<td class="image-prod">
													<div class="img" style="background-image:url(${ favorData.imageUrl });"></div>
												</td>

												<td class="product-name">
													<a href="teaDetailPage.do?favor=1&teaNum=${ favorData.teaNum }"><h3>${ favorData.teaName }</h3></a>
													<p>${ favorData.teaContent }</p>
												</td>
									...
									$(document).ready(function(){
										...
										function emptyCart() {
											if ($('#cartTbody').children('tr').length < 2) {
												var emptyMsg = "<tr>"
															 + "<td colspan='4'>찜한 상품이 없습니다.</td>"
															 + "</tr>";
												$('#cartTbody').append(emptyMsg);
											}
										}
